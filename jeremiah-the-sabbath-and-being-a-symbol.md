...
God calls [🧑 Jeremiah](p-jeremiah.md) to preach tis message at the gates of [city-jerusalem](../city-jerusalem.md). This message is a clear and concise call to follow the Sabbath rest rather than working on that day. This includes a promise of blessings and a true king. The threat comes at the end that Jerusalem would be destroyed (which is the final result when [nation-babylon](nation-babylon.md) invades). The gate that God has Jeremiah go to is the busiest  gate which remember that Gates also functioned as the courthouse/business center of a city [^enduring-word] [^matthew-henry]. 
